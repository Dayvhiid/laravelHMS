<style>
  ...
  <title>SignUp</title>
  <div class="container">
      <form class="px-4 py-3" method="POST" action="{{ route('register.check')}}">   
        @csrf
        @method('POST')   
     ...
     {{-- <div>
      <button type="button" class="btn btn-primary" id="signup" onclick="location.href='{{route('register.signup') }}'">Sign Up</button>
     </div> --}}
    </div>
  </body>
  </html>