...
<body>
    <form action="{{route('lens.store')}}" method="POST">
        ...
        @endif
        <ul>
          <li><a href="{{ route('admin2.lenslist') }}">Lens List</a></li>
        </ul>
            <table class="table table-bordered" id="table">
                ...
                <tr>
                    <td><input type="text" name="inputs[0][sn]" placeholder="Enter SN" class="form-control" required></td>
                    <td><input type="text" name="inputs[0][name]" class="form-control" placeholder="Enter lens Name" required></td>
                    <td><input type="text" name="inputs[0][price]" placeholder="Enter Lens Price" class="form-control" required></td>
                    <td><input type="text" name="inputs[0][special_code]" placeholder="Enter Unique Code" class="form-control" required></td>
                    <td><input type="text" name="inputs[0][quantity]" placeholder="Quantity" class="form-control" required></td>
                    {{-- <td>
