      ...
      <div class="layout-container flex h-full grow flex-col">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f1f2f4] px-10 py-3">
          <div class="flex items-center gap-4 text-[#121416]">
            ...
            <h2 class="text-[#121416] text-lg font-bold leading-tight tracking-[-0.015em]">Drugs</h2>
          </div>
        ...
        <div class="px-40 flex flex-1 justify-center py-5">
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div class="flex flex-wrap justify-between gap-3 p-4"><p class="text-[#121416] tracking-light text-[32px] font-bold leading-tight min-w-72">Enter Drug Details</p></div>
                  ...
                  <tbody id="tableBody">
                    <tr class="border-t border-t-[#dde1e3]">
                      ...
                      <td class="table-bd426a45-3b65-4bc2-a180-0d5449f4261c-column-600 h-[72px] px-4 py-2 w-[400px] text-[#6a7681] text-sm font-normal leading-normal">
                        ...
                        <td class="table-c4860cee-8f7d-4b1a-bf8b-d55602fb8fe0-column-720 h-[72px] px-4 py-2 w-60 text-[#5c748a] text-sm font-bold leading-normal tracking-[0.015em]">
                         <select name="inputs[0][drug_type]" class="w-full h-10 px-3 py-2 text-sm text-[#5c748a] font-bold bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 tracking-[0.015em]">
    ...
    <script>
      ...
      function addNewRow() {
        ...
        newRow.innerHTML = `
          ...
          <td class="table-c4860cee-8f7d-4b1a-bf8b-d55602fb8fe0-column-720 h-[72px] px-4 py-2 w-60 text-[#5c748a] text-sm font-bold leading-normal tracking-[0.015em]">
                         <select name="inputs[${rowCount}][drug_type]" class="w-full h-10 px-3 py-2 text-sm text-[#5c748a] font-bold bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 tracking-[0.015em]">
                                <option value="">Select Drug Type</option>
                                <option value="eye_drop">Eye Drop</option>
                                <option value="Tablet">Tablet</option>
                                <!-- Add more options as needed -->
