...
<body>
    <div class="relative flex size-full min-h-screen flex-col bg-slate-50 group/design-root overflow-x-hidden"
        ...
        <div class="layout-container flex h-full grow flex-col">
            <header
                class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7eef3] px-10 py-3">
            ...
            <div class="px-10 flex flex-1 justify-center py-5">
                <div class="layout-content-container flex flex-col max-w-[960px] flex-1" id="chat-section">
                    <div class="flex items-center justify-between px-4 py-3">
                        <h3 id="room-name" class="text-[#0e161b] text-lg font-bold leading-tight tracking-[-0.015em]">
                            Room: </h3>
                        <button id="leave-btn"
                        ...
                        <div class="flex gap-4 mb-4">
                            <div class="flex-1">
                                ...
                                <video id="local-video" autoplay muted playsinline
                                    class="w-full rounded-lg bg-gray-200 aspect-video"></video>
                            </div>
                            <div class="flex-1">
                    ...
                    <div class="flex-1 px-4 py-3">
                        <div id="messages"
                            class="flex flex-col gap-3 bg-slate-50 rounded-lg p-4 overflow-y-auto h-96 border border-[#e7eef3]">
                        </div>
                    </div>
                        ...
                        <label class="flex flex-col min-w-40 h-12 flex-1">
                            <div class="flex w-full flex-1 items-stretch rounded-lg h-full">
                                <input id="message-input" placeholder="Type a message"
                                    class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0e161b] focus:outline-0 focus:ring-0 border-none bg-[#e7eef3] focus:border-none h-full placeholder:text-[#4e7a97] px-4 rounded-r-none border-r-0 pr-2 text-base font-normal leading-normal"
                                    value="" />
                                <div
                                    class="flex border-none bg-[#e7eef3] items-center justify-center pr-4 rounded-r-lg border-l-0">
                                    <div class="flex items-center gap-4 justify-end">
                                        ...
                                        <button id="send-btn"
                                            class="min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-8 px-4 bg-[#1994e6] text-slate-50 text-sm font-medium leading-normal">
    ...
    <script>
        ...
        let peer, localStream, peerId, peerCall;
        ...
        // Video call functionality (PeerJS)
        ...
        startCallBtn.addEventListener('click', async () => {
            try {
                ...
                peerId = `${roomCode}-${doctor}-${Math.floor(Math.random()*10000)}`;
                ...
                // Listen for remote peerId from socket
                socket.on('peer-open', ({
                    peerId: remotePeerId
                }) => {
